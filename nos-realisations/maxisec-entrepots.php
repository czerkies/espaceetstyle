...
include('../ele/doc.php');
?>
		<title>Agencement Entrepots Maxisec Entrepots | Espace et Style</title>
	...
	<?php include('../ele/head_menu.php'); ?>
				<div class="rea">
					<div class="rea_img">
						<img class="rea_img_dim" src="img/Maxisec_Entrepots.jpg" alt="Maxisec Entrepots - Espace et Style">
