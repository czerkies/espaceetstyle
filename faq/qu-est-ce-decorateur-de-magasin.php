...
?>
        ...
        <div id="faq" class="bloc_s_menu">
	        ...
	        Suite à cette conception du <strong>nouveau design du magasin</strong>, en tant que maître d’œuvre, le décorateur de magasin coordonnera tous les intervenants qui réaliseront les travaux.<br>
	        Le décorateur de magasin ou décorateur de boutique est donc le compositeur et le chef d’orchestre menant les travaux qui aboutiront à vous offrir un nouvel espace de travail.<br>Ainsi, le décorateur de magasin, ou décorateur de boutique étudie avec vous l’ensemble de vos besoins afin de traduire en volume et en <strong>réalisation vos objectifs</strong> de travaux de rénovation de boutique ou d’agencement de magasin.</p>
			</div>
		</div>
	</div>
